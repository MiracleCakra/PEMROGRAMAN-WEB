...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Mempersiapkan parameter untuk query
    $params = array(
        $_POST['judul'],
        $_POST['deskripsi'],
        $_POST['harga'],
...
$sql = "SELECT * FROM penjualan_buku WHERE id_buku = ?";
$params = array($id);
$stmt = sqlsrv_query($conn, $sql, $params); // Eksekusi query dengan parameter id
$buku = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC); // Ambil data buku dalam bentuk array asosiatif
